...
const { getRepo, getRepos, createRepo, updateRepo, deleteRepo, getRepoFolders, createRepoFolder, getNotes, createNote, updateNote, getNote, getRepoFolder, deleteRepoFolder, noteRepoFolder, startRepoSession, endRepoSession, getFlashcards, createFlashcard } = require('../controllers/repoController')
...
router.post('/flashcards', protect, createFlashcard)
